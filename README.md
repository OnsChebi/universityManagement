# Employee-Tracker-App-in-Asp.Net-Core-MVC
This is an UniversityManagement App in Asp.Net Core MVC using SyncFusion Components.

This is a complete Asp.Net Core application to demonstrate the building an enterprise application from scratch.

Discussed Points :
Implemented CRUD Operation of Category & Person
...
alt="Video demonstrating creation of an UniversityManagement application from scratch" width="500" height="400" border="10" /></a>
